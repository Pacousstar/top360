    ...
    <footer className="bg-green-900 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-xl font-bold mb-4">TOP 360°</h3>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><Link to="/map" className="text-green-200 hover:text-white">Carte interactive</Link></li>
              <li><Link to="/register" className="text-green-200 hover:text-white">Inscription</Link></li>
              <li><Link to="/login" className="text-green-200 hover:text-white">Connexion</Link></li>
            </ul>
          </div>
          <div>
